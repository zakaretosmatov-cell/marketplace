New-Item -ItemType Directory -Force -Path "src/app/orders" | Out-Null
New-Item -ItemType Directory -Force -Path "src/app/orders/[id]" | Out-Null
...
'@
Set-Content -Path "src/app/orders/page.tsx" -Value $list -Encoding UTF8
Write-Host "orders list written"
